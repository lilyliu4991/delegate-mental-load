...
export default function SummaryPanel({ summary, totalTasks, onReset, onExport }: Props) {
  return (
    <div className="sticky top-20 bg-white border border-stone-200 p-6 space-y-6">
      <div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="p-4 border border-stone-100" style={{ background: '#EAF5F5' }}>
          <div className="font-serif text-2xl" style={{ color: '#5AABAB' }}>{summary.partner1Percent}%</div>
        ...
        <div className="p-4 border border-stone-100" style={{ background: '#F2F7F7' }}>
          <div className="font-serif text-2xl" style={{ color: '#6FA3A8' }}>{summary.partner2Percent}%</div>
        ...
        <div className="p-4 border border-stone-100 bg-[#F8F4EF]">
          <div className="font-serif text-2xl text-stone-700">{summary.sharedCount}</div>
          <div className="text-xs text-stone-400 mt-0.5" style={{ fontFamily: 'Sweet Sans Pro, system-ui' }}>Shared tasks</div>
        </div>
        <div className="p-4 border border-stone-100 bg-[#F8F4EF]">
          <div className="font-serif text-2xl text-stone-700">{summary.neitherCount}</div>
